...
export function TournamentInfoPage() {
        ...
        matches: [
          {
            ...
            player1: { uid: "1", name: "Alan" },
            player2: { uid: "2", name: "Tim" },
            scheduledOn: new Date(),
          },
          {
            uid: "2",
            name: "Quarter Finals 2",
            player1: { uid: "3", name: "John" },
            player2: { uid: "4", name: "Jim" },
            scheduledOn: new Date(),
            score1: "20",
            score2: "7",
          },
  ...
  return (
    <div className="h-full flex flex-col items-center">
      <header className="container min-h-1/10">
        <div>
...
function MatchCard({ match }: MatchCardProps) {
  return (
    <div className="rounded-lg shadow-md p-4 bg-green-50 flex-1">
      <div className="flex justify-center">{match.name}</div>
      <div className="flex justify-center text-gray-500">
        Starts at {match.scheduledOn.toLocaleString()}
      </div>
